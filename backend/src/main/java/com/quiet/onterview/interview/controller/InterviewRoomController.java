...
public class InterviewRoomController {
    ...
    @PostMapping
    public ResponseEntity<Void> registerInterviewRoom(@RequestBody InterviewRoomRequest interviewRoomRequest) {
        interviewRoomService.createInterviewRoom(interviewRoomRequest);
